    ...
    function serveAdminPage() {
        ...
        $data = array(
            ...
            'i18n'        => array(
                ...
                'checkAll'           => __('Allow all'),
                'clearAll'           => __('Block all'),
                'invertSelection'    => __('Invert selection'),
                'applyToVisible'     => __('Apply to visible:'),
                'bulkCheckAll'       => __('Allow all'),
                'bulkClearAll'       => __('Block all'),
                'confirmBulk'        => __('Apply to %d rows? Click Save All to persist.'),
